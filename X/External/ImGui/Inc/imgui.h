...
namespace ImGui
{
    ...
    // Windows Scrolling
    IMGUI_API float         GetSceenX();                                                   // get scrolling amount [0..GetScrollMaxX()]
    IMGUI_API float         GetSceenY();                                                   // get scrolling amount [0..GetScrollMaxY()]
    IMGUI_API float         GetScrollMaxX();                                                // get maximum scrolling amount ~~ ContentSize.X - WindowSize.X
    IMGUI_API float         GetScrollMaxY();                                                // get maximum scrolling amount ~~ ContentSize.Y - WindowSize.Y
    IMGUI_API void          SetSceenX(float scroll_x);                                     // set scrolling amount [0..GetScrollMaxX()]
    IMGUI_API void          SetSceenY(float scroll_y);                                     // set scrolling amount [0..GetScrollMaxY()]
