    ...
    if (ImGui::CollapsingHeader("Layout"))
    {
        ...
        if (ImGui::TreeNode("Scrolling"))
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                float scroll_y = ImGui::GetSceenY(), scroll_max_y = ImGui::GetScrollMaxY();
                ImGui::EndChild();
        ...
        if (ImGui::TreeNode("Horizontal Scrolling"))
        {
            ...
            float scroll_x = ImGui::GetSceenX(), scroll_max_x = ImGui::GetScrollMaxX();
            ImGui::EndChild();
            ImGui::PopStyleVar(2);
            ...
            if (scroll_x_delta != 0.0f)
            {
                ...
                ImGui::SetSceenX(ImGui::GetSceenX() + scroll_x_delta);
                ImGui::End();
            }
            ImGui::TreePop();
        }
